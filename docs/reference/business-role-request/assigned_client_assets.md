...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business-role-request/assigned_client_assets"
...
try {
  ...
  $response = $fb->get(
    '/{business-role-request-id}/assigned_client_assets',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-role-request-id}/assigned_client_assets"
                                      parameters:params
                                      HTTPMethod:@"GET"];
