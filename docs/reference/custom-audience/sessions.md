...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/custom-audience/sessions"
...
| --- | --- |
| `session_id`<br><br>*int64* | Session ID<br> |
...
A list of [CustomAudienceSession](https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/custom-audience-session) nodes.
