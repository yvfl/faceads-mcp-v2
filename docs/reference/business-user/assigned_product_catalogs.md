...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business-user/assigned_product_catalogs"
...
try {
  ...
  $response = $fb->get(
    '/{business-user-id}/assigned_product_catalogs',
    '{access-token}'
  );
