...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business-user/assigned_creative_folders"
...
try {
  ...
  $response = $fb->get(
    '/{business-user-id}/assigned_creative_folders',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-user-id}/assigned_creative_folders"
                                      parameters:params
                                      HTTPMethod:@"GET"];
...
A list of [BusinessCreativeFolder](https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business-creative-folder) nodes.
