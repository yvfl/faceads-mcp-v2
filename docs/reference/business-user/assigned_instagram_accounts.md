...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business-user/assigned_instagram_accounts"
...
try {
  ...
  $response = $fb->get(
    '/{business-user-id}/assigned_instagram_accounts',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-user-id}/assigned_instagram_accounts"
                                      parameters:params
                                      HTTPMethod:@"GET"];
...
| Field | Description |
| --- | --- |
| `permitted_roles`<br><br>*list<string>* | Permitted roles<br> |
