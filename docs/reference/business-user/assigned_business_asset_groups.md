...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business-user/assigned_business_asset_groups"
...
try {
  ...
  $response = $fb->get(
    '/{business-user-id}/assigned_business_asset_groups',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-user-id}/assigned_business_asset_groups"
                                      parameters:params
                                      HTTPMethod:@"GET"];
