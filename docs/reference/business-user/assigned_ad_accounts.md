...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business-user/assigned_ad_accounts"
...
try {
  ...
  $response = $fb->get(
    '/{business-user-id}/assigned_ad_accounts',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-user-id}/assigned_ad_accounts"
                                      parameters:params
                                      HTTPMethod:@"GET"];
