...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ad-campaign/message_delivery_estimate"
...
try {
  ...
  $response = $fb->get(
    '/{ad-set-id}/message_delivery_estimate',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{ad-set-id}/message_delivery_estimate"
                                      parameters:params
                                      HTTPMethod:@"GET"];
