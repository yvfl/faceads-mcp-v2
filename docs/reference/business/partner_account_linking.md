...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/partner_account_linking"
...
get partner_account_linking for specific business
...
try {
  ...
  $response = $fb->get(
    '/{business-id}/partner_account_linking',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-id}/partner_account_linking"
                                      parameters:params
                                      HTTPMethod:@"GET"];
