...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/an_publisher_blocklist_pages"
...
try {
  ...
  $response = $fb->get(
    '/{business-id}/an_publisher_blocklist_pages',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-id}/an_publisher_blocklist_pages"
                                      parameters:params
                                      HTTPMethod:@"GET"];
...
| --- | --- |
| `page_ids`<br><br>*array<numeric string>* | Returns data only for these IDs if specified<br> |
