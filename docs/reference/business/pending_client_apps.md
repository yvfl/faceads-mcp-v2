...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/pending_client_apps"
...
| Field | Description |
| --- | --- |
| `is_requested`<br><br>*bool* | True if the business requested access to the app and false if the app is being shared to the business<br> |
