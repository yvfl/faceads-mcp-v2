...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/managed_partner_ads_funding_source_details"
...
try {
  ...
  $response = $fb->get(
    '/{business-id}/managed_partner_ads_funding_source_details',
    '{access-token}'
  );
...
| --- | --- |
| `year_quarter`<br><br>*string* | year_quarter<br> |
