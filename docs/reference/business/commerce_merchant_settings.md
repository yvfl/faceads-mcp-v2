...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/commerce_merchant_settings"
...
try {
  ...
  $response = $fb->get(
    '/{business-id}/commerce_merchant_settings',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-id}/commerce_merchant_settings"
                                      parameters:params
                                      HTTPMethod:@"GET"];
