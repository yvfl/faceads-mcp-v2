...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/pending_client_ad_accounts"
...
try {
  ...
  $response = $fb->get(
    '/{business-id}/pending_client_ad_accounts',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-id}/pending_client_ad_accounts"
                                      parameters:params
                                      HTTPMethod:@"GET"];
