...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/collaborative_ads_suggested_partners"
...
Suggested [Collaborative Ads](collaborative-ads.md#collaborative-ads) partners for a business.
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-id}/collaborative_ads_suggested_partners"
                                      parameters:params
                                      HTTPMethod:@"GET"];
