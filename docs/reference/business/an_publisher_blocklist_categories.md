...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/an_publisher_blocklist_categories"
...
try {
  ...
  $response = $fb->get(
    '/{business-id}/an_publisher_blocklist_categories',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-id}/an_publisher_blocklist_categories"
                                      parameters:params
                                      HTTPMethod:@"GET"];
