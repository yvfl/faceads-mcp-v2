...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/sso_migrated_business_users"
...
try {
  ...
  $response = $fb->get(
    '/{business-id}/sso_migrated_business_users',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-id}/sso_migrated_business_users"
                                      parameters:params
                                      HTTPMethod:@"GET"];
