...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/partners"
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-id}/partners"
                                      parameters:params
                                      HTTPMethod:@"GET"];
...
| Field | Description |
| --- | --- |
| `filtered_total_count`<br><br>*int32* | Filtered total number of objects on this edge<br><br><br>**[default]**<br> |
