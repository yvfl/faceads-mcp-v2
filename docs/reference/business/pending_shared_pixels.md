...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/pending_shared_pixels"
...
try {
  ...
  $response = $fb->get(
    '/{business-id}/pending_shared_pixels',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-id}/pending_shared_pixels"
                                      parameters:params
                                      HTTPMethod:@"GET"];
