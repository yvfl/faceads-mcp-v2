...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/client_publisher_block_lists"
...
try {
  ...
  $response = $fb->get(
    '/{business-id}/client_publisher_block_lists',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-id}/client_publisher_block_lists"
                                      parameters:params
                                      HTTPMethod:@"GET"];
