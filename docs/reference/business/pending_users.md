...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/pending_users"
...
| --- | --- |
| `email`<br><br>*string* | Email of person invited to access this business.<br> |
...
A list of [BusinessRoleRequest](reference/business-role-request.md) nodes.
