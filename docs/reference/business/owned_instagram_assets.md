...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/owned_instagram_assets"
...
try {
  ...
  $response = $fb->get(
    '/{business-id}/owned_instagram_assets',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-id}/owned_instagram_assets"
                                      parameters:params
                                      HTTPMethod:@"GET"];
