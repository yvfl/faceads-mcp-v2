...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/business_asset_groups"
...
try {
  ...
  $response = $fb->get(
    '/{business-id}/business_asset_groups',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-id}/business_asset_groups"
                                      parameters:params
                                      HTTPMethod:@"GET"];
...
| Field | Description |
| --- | --- |
| `total_count`<br><br>*int32* | Total number of business asset groups for this business.<br><br><br>**[default]**<br> |
