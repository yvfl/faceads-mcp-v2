...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/adnetworkanalytics_results"
...
| --- | --- |
| `query_ids`<br><br>*list<string>* | **Default value: **`Vec`<br>Set of query ids to get result for<br> |
