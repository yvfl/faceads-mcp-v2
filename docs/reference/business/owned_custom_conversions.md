...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/owned_custom_conversions"
...
try {
  ...
  $response = $fb->get(
    '/{business-id}/owned_custom_conversions',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-id}/owned_custom_conversions"
                                      parameters:params
                                      HTTPMethod:@"GET"];
