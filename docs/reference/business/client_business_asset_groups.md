...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/client_business_asset_groups"
...
try {
  ...
  $response = $fb->get(
    '/{business-id}/client_business_asset_groups',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-id}/client_business_asset_groups"
                                      parameters:params
                                      HTTPMethod:@"GET"];
...
| Field | Description |
| --- | --- |
| `permitted_tasks`<br><br>*list<string>* | permitted_tasks<br> |
