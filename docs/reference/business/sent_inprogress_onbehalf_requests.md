...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/sent_inprogress_onbehalf_requests"
...
IN_PROGRESS on behalf requests sent by the business
...
try {
  ...
  $response = $fb->get(
    '/{business-id}/sent_inprogress_onbehalf_requests',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{business-id}/sent_inprogress_onbehalf_requests"
                                      parameters:params
                                      HTTPMethod:@"GET"];
