...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/system-user/assigned_monetization_properties"
...
try {
  ...
  $response = $fb->get(
    '/{system-user-id}/assigned_monetization_properties',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{system-user-id}/assigned_monetization_properties"
                                      parameters:params
                                      HTTPMethod:@"GET"];
