...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/product-catalog/product_groups"
...
try {
  ...
  $response = $fb->get(
    '/{product-catalog-id}/product_groups',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{product-catalog-id}/product_groups"
                                      parameters:params
                                      HTTPMethod:@"GET"];
...
A list of [ProductGroup](https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/product-group) nodes.
