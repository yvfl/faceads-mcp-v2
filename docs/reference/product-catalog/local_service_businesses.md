...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/product-catalog/local_service_businesses"
...
try {
  ...
  $response = $fb->get(
    '/{product-catalog-id}/local_service_businesses',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{product-catalog-id}/local_service_businesses"
                                      parameters:params
                                      HTTPMethod:@"GET"];
...
| Field | Description |
| --- | --- |
| `total_count`<br><br>*unsigned int32* | Total list of local service businesses fetched by this query<br> |
