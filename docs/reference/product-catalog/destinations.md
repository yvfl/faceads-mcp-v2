...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/product-catalog/destinations"
...
Travel destinations in a catalog. See [Dynamic Ads for Travel, Catalog Setup](travel-ads.md).
...
try {
  ...
  $response = $fb->get(
    '/{product-catalog-id}/destinations',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{product-catalog-id}/destinations"
                                      parameters:params
                                      HTTPMethod:@"GET"];
...
| Field | Description |
| --- | --- |
| `total_count`<br><br>*unsigned int32* | Total number of destinations returned by the query<br> |
