...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/product-catalog/catalog_segments"
...
try {
  ...
  $response = $fb->get(
    '/{product-catalog-id}/catalog_segments',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{product-catalog-id}/catalog_segments"
                                      parameters:params
                                      HTTPMethod:@"GET"];
