...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ad-study/related_ad_accounts"
...
try {
  ...
  $response = $fb->get(
    '/{ad-study-id}/related_ad_accounts',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{ad-study-id}/related_ad_accounts"
                                      parameters:params
                                      HTTPMethod:@"GET"];
