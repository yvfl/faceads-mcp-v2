...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ads-pixel/cloudbridge_dataset_status"
...
try {
  ...
  $response = $fb->get(
    '/{ads-pixel-id}/cloudbridge_dataset_status',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{ads-pixel-id}/cloudbridge_dataset_status"
                                      parameters:params
                                      HTTPMethod:@"GET"];
