...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ads-pixel/event_last_fired_time"
...
try {
  ...
  $response = $fb->get(
    '/{ads-pixel-id}/event_last_fired_time',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{ads-pixel-id}/event_last_fired_time"
                                      parameters:params
                                      HTTPMethod:@"GET"];
...
| --- | --- |
| `event`<br><br>*string* | The pixel event we want to fetch last fired time for<br> |
