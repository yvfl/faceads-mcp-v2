...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ads-pixel/integration_quality"
...
try {
  ...
  $response = $fb->get(
    '/{ads-pixel-id}/integration_quality',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{ads-pixel-id}/integration_quality"
                                      parameters:params
                                      HTTPMethod:@"GET"];
...
| --- | --- |
| `agent_name`<br><br>*string* | agent_name<br> |
| `time_range`<br><br>*string* | time_range<br> |
