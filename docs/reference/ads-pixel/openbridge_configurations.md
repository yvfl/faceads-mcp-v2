...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ads-pixel/openbridge_configurations"
...
try {
  ...
  $response = $fb->get(
    '/{ads-pixel-id}/openbridge_configurations',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{ads-pixel-id}/openbridge_configurations"
                                      parameters:params
                                      HTTPMethod:@"GET"];
