...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ads-pixel/agencies"
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{ads-pixel-id}/agencies"
                                      parameters:params
                                      HTTPMethod:@"GET"];
...
| Field | Description |
| --- | --- |
| `permitted_roles`<br><br>*list<string>* | permitted_roles<br> |
...
Refer to [Pixel Agency Sharing](https://developers.facebook.com/documentation/ads-commerce/marketing-api/business-asset-management/guides/business-pixel-sharing) guide
