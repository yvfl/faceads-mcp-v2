...
source: "https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ads-pixel/analytics_segments"
...
try {
  ...
  $response = $fb->get(
    '/{ads-pixel-id}/analytics_segments',
    '{access-token}'
  );
...
FBSDKGraphRequest *request = [[FBSDKGraphRequest alloc]
                               initWithGraphPath:@"/{ads-pixel-id}/analytics_segments"
                                      parameters:params
                                      HTTPMethod:@"GET"];
